      ...
      <div className="border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_NUMBER?.replace(/\D/g, '')}`} aria-label="WhatsApp" className="text-gray-500 dark:text-gray-400 hover:text-[#25D366] dark:hover:text-[#25D366]">
            ...
            <a href={`https://instagram.com/${process.env.NEXT_PUBLIC_INSTAGRAM}`} aria-label="Instagram" className="text-gray-500 dark:text-gray-400 hover:text-[#FF0069] dark:hover:text-[#FF0069]">
            ...
            <a href={`https://facebook.com/${process.env.NEXT_PUBLIC_FACEBOOK}`} aria-label="Facebook" className="text-gray-500 dark:text-gray-400 hover:text-[#0866FF] dark:hover:text-[#0866FF]">
            ...
            <a href={`https://tiktok.com/@${process.env.NEXT_PUBLIC_TIKTOK}`} aria-label="TikTok" className="text-gray-500 dark:text-gray-400 hover:text-[#000000] dark:hover:text-[#25F4EE]">
            ...
            <a href={`https://shopee.co.id/${process.env.NEXT_PUBLIC_SHOPEE}`} aria-label="Shopee" className="text-gray-500 dark:text-gray-400 hover:text-[#EE4D2D] dark:hover:text-[#EE4D2D]">
